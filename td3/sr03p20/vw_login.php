...
<body>
  ...
  <section>
      ...
      } else if (isset($_REQUEST["forbiddenvalue"])) {
        echo '<p class="errmsg">Votre login/mot de passe est invalid. '.$_REQUEST["forbiddenvalue"].'</p>';
      } else if (isset($_REQUEST["inexistelogin"])) {
        echo '<p class="errmsg">Votre login n\'exsite pas</p>';
      }
      ?>
  </section>
