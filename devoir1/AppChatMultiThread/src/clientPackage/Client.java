...
/**
 * 
 * Établir le socket de connexion entre le client et le serveur.
 * Récupérer les entrées et ainsi les sorties de streams.
 * Créer deux threads pour envoyer et recevoir de message et puis les lance.
 * 
